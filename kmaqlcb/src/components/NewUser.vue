  ...
  <div class="content">
    <div class="grid-container">
      ...
      <div class="grid-item">
        ...
        <NcDatetimePicker ref="day_joined" format="DD/MM/YYYY" class="nc-picker" id="day_joined" :clearable="true"
      ...
      <div class="grid-item">
        ...
        <NcDatetimePicker ref="date_of_birth" format="DD/MM/YYYY" class="nc-picker" id="date_of_birth" :clearable="true"
      ...
      <div class="grid-item">
        ...
        <NcDatetimePicker format="DD/MM/YYYY" class="nc-picker" id="communist_party_joined" :clearable="true"
      ...
      <div class="grid-item full-width">
        <div class="button_actions_container">
          <div class="button_actions">
            <NcButton to="/hoso" type="secondary" class="button">
              Hủy
            </NcButton>
...
export default {
  ...
  methods: {
    ...
    async getNCUsers() {
      try {
        const response = await axios.get(generateUrl('apps/kmaqlcb/nc_users'))
    ...
    async createUser() {
      try {
        ...
        const response = await axios.post('/apps/kmaqlcb/create_user', {
