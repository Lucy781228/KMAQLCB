...
export default {
    ...
    methods: {
        ...
        async deleteUnit(id) {
            try {
                const response = await axios.delete(generateUrl('apps/kmaqlcb/delete_unit/' + id))
            } catch (e) {
                console.error(e)
            }
        },
        async deletePosition(id) {
            try {
                const response = await axios.delete(generateUrl('apps/kmaqlcb/delete_position/' + id))
            } catch (e) {
                console.error(e)
            }
        },
        async deleteDiploma(id) {
            try {
                const response = await axios.delete(generateUrl('apps/kmaqlcb/delete_diploma/' + id))
            } catch (e) {
                console.error(e)
            }
        },
        ...
        async createUnit() {
            try {
                const response = await axios.post('/apps/kmaqlcb/create_unit', {
        ...
        async createPosition() {
            try {
                const response = await axios.post('/apps/kmaqlcb/create_position', {
        ...
        async createDiploma() {
            try {
                const response = await axios.post('/apps/kmaqlcb/create_diploma', {
