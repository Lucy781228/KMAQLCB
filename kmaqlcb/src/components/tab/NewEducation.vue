    ...
    <NcModal v-if="modal" @close="closeModal" size="large" :canClose="false">
        <div class="modal__content">
            ...
            <div class="grid-item">
                ...
                <Multiselect id="diploma_id" v-model="diplomaId" :options-list="formatDiplomas" :id="diplomaId" :allow-delete="isEdit"
...
export default {
    ...
    methods: {
        ...
        async getDiplomas() {
            try {
                const response = await axios.get(generateUrl('apps/kmaqlcb/diplomas'))
        ...
        async createEducation() {
            try {
                const response = await axios.post('/apps/kmaqlcb/create_education', {
        ...
        async updateEducation() {
            try {
                const response = await axios.put('/apps/kmaqlcb/update_education', {
                    diploma_id: this.diplomaId,
