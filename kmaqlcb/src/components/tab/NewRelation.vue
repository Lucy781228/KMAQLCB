...
export default {
    ...
    methods: {
        ...
        async createRelation() {
            try {
                const response = await axios.post('/apps/kmaqlcb/create_relation', {
        ...
        async updateRelation() {
            try {
                const response = await axios.put('/apps/kmaqlcb/update_relation', {
                    full_name: this.fullName,
        ...
        async getTypes() {
            try {
                const response = await axios.get(generateUrl(`/apps/kmaqlcb/relation_types/${this.qlcbUid}`))
