...
class BusinessService {
    ...
    public function updateBusiness($qlcb_uid, $start_date, $end_date, $unit, $position, $business_id) {
        $query = $this->db->prepare('UPDATE `oc_kmaqlcb_business` SET 
